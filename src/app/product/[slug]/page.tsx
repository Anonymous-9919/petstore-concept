...
import { formatPrice, cn, getBestPrice, calcDiscount, stripHtml, getProductImage } from "@/lib/utils";
...
export default function ProductPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const shortDesc = lang === "ar" ? (product as unknown as { ar_short_description?: string }).ar_short_description || product.short_description : product.short_description;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
            ...
            <div>
              ...
              <div className="flex gap-3 mb-6">
                ...
                <button
                  onClick={() => wishlisted ? removeWishlist(product.id) : addWishlist(product.id)}
                  className={cn(
            ...
            <div className="prose prose-sm max-w-none text-gray-700">
              {activeTab === "description" ? (
                description ? (
                  ...
                  <p className="text-gray-500">{t("general.no_description", lang) || "No description available."}</p>
                )
              ) : (
